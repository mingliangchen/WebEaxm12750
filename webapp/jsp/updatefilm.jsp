...
<body>
	...
	<form action="<%=path%>/FilmServlet" method="get">
		<input name="command" value="modify" style="display: none;">
		 film_id:<input name="film_id" value="${film.film_id}" ><br>
		title:<input name="title" type="text" value="${film.title}"><br>
		description:<input name="description" type="text" value="${film.description}"><br>
